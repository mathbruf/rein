...
| 023 | 2026-08-09 | proposed | **Snow-cover layer (senorge.no / Sentinel-2)** | The brief lists lingering snowfields as insect refuges + cooling spots; the layer was deferred through all phases. Most valuable for the early (warm) season; low priority for the autumn hunt window the validation covers | Claude |
